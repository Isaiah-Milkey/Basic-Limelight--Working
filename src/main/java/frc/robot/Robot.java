...
// // double tshort = tshortEntry.getString(); // Sidelength of shortest side ofthe fitted bounding box (pixels)
// double tlong = tlong; // Sidelength of longest side of the fitted bounding box(pixels)
// double thor = thor; // Horizontal sidelength of the rough bounding box (0 -320 pixels)
// double tvert = tvert; // Vertical sidelength of the rough bounding box (0 -320 pixels)
